...
*/
unsigned int XportBridge::toCounterparty(uint8_t* buf, unsigned int len, int8_t mm) {
  switch (mm) {
...
*/
unsigned int XportBridge::fromCounterparty(uint8_t* buf, unsigned int len, int8_t mm) {
  switch (mm) {
    case MEM_MGMT_RESPONSIBLE_CALLER:
      // NOTE: No break. This might be construed as a way of saying CREATOR.
    case MEM_MGMT_RESPONSIBLE_CREATOR:
