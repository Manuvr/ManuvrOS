...
This file is for Apple support.
*/
...
*******************************************************************************/
void ApplePlatform::printDebug(StringBuilder* output) {
  output->concatf(
    "==< %s Apple [%s] >=============================\n",
    _board_name,
...
*/
void ApplePlatform::jumpToBootloader() {
...
void ApplePlatform::hardwareShutdown() {
...
*/
int8_t ApplePlatform::platformPreInit(Argument* root_config) {
...
*/
int8_t ApplePlatform::platformPostInit() {
  set_linux_interval_timer();
  return 0;
}
