...
const TypeCodeDef type_codes[] = {
  ...
  {TCode::COLOR8        , (TYPE_CODE_FLAG_EXPORTABLE), 1, "COLOR8"},
  {TCode::COLOR16       , (TYPE_CODE_FLAG_EXPORTABLE), 1, "COLOR16"},
  {TCode::COLOR24       , (TYPE_CODE_FLAG_EXPORTABLE), 1, "COLOR24"},
  {TCode::COLOR32       , (TYPE_CODE_FLAG_EXPORTABLE), 1, "COLOR32"},
  ...
  {TCode::CBOR          , (TYPE_CODE_FLAG_EXPORTABLE | TYPE_CODE_FLAG_VARIABLE_LENGTH), 1, "CBOR"},
