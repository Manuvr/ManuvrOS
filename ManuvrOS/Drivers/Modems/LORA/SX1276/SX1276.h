...
class SX1276 : public BusOpCallback
  ...
  public:
    ...
    int8_t init(SPIAdapter*);
      ...
      inline const char* consoleName() {  return "SX1276";  };
  ...
  private:
    ...
    static const uint8_t _get_reg_addr(SX127xRegister);
    static const SX127xRegister _reg_id_from_addr(uint8_t addr);
};
