...
#define VEML6070_REG_DATA_LSB         0x02
#define VEML6070_REG_DATA_MSB         0x03

#define VEML6070_I2CADDR              0x38


class VEML6070 : public I2CDevice, public SensorWrapper {
  public:
    VEML6070();
    VEML6070(uint8_t pin);
    ~VEML6070();
