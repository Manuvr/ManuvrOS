...
class LSM303_Accel : public IMU {
  ...
  private:
    ...
    static constexpr const int8_t _ADDRESS  = (0x32 >> 1);         // 0011001x
};


/* Unified sensor driver for the magnetometer */
class LSM303_Mag : public IMU {
  public:
    LSM303_Mag();
  ...
  private:
    ...
    static constexpr const int8_t _ADDRESS  = (0x3C >> 1);         // 0011110x
};
